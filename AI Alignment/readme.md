Large language models are increasingly capable, but raw capability does not guarantee behaviour that is reliable, safe, or consistent with human goals. AI alignment studies how to train and evaluate models so that they better follow human intentions, preferences, and values. This is an active research area, with ongoing work in communities such as the [BiAlign 2026](https://bialign-workshop.github.io/2026), where researchers study human–AI alignment, value-centered design, human feedback, and scalable post-training methods. One important line of work in this direction is RLHF, along with newer alternatives such as DPO.
